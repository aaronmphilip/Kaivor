        ...
        val goal = when (action) {
            "search", "find" -> {
                ...
                buildString {
                    ...
                    append("⚠️ Do NOT add to cart yet.")
                }
            }
            ...
            "order", "add" -> {
                ...
                val goal = buildString {
                    ...
                    appendLine("⚠️ STOP before checkout — do NOT tap 'Proceed to pay'.")
                    append("⚠️ If you see a weight/size variant pop-up, choose the first available option.")
                }
