    ...
    override suspend fun execute(context: SkillContext, params: Map<String, Any>): SkillResult {
        ...
        for ((idx, contact) in contacts.withIndex()) {
            val goal = buildString {
                ...
                append("⚠️ NEVER enter UPI PIN. NEVER make a payment. Only DRAFT the request.\n")
                append("⚠️ If a UPI PIN screen appears, press back immediately.\n")
        ...
        val summary = buildString {
            ...
            appendLine()
            appendLine("⚠️ Each request is *drafted but not sent*. Open PhonePe → Requests tab to review and send.")
        }
