        ...
        val goal = when (action) {
            ...
            "buy", "add_to_cart", "order", "purchase" -> {
                val goal = buildString {
                    ...
                    append("DO NOT tap the search bar, camera (icon), or mic (icon) icons at the top.\n\n")
                    append("STEPS:\n")
            ...
            "search" -> buildString {
                ...
                append("   The camera (icon) opens photo search. The mic (icon) opens voice search. NEVER tap them.\n")
                ...
                append("NEVER tap the camera (icon) or mic (icon) icons next to the search bar.\n")
