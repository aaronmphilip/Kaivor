...
import com.kaivor.agent.AgentAccessibilityService
import com.kaivor.agent.ScreenElement
...
class SandboxedRunner(
    ...
    fun setClipboard(text: String) {
        ...
        clipboard.setPrimaryClip(android.content.ClipData.newPlainText("kaivor", text))
    }
