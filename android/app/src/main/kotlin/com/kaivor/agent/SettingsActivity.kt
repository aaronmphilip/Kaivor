...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        learningEnabled = getSharedPreferences("kaivor_memory", MODE_PRIVATE)
        ...
        findViewById<Button>(R.id.btnSave).setOnClickListener {
            ...
            getSharedPreferences("kaivor_memory", MODE_PRIVATE)
        ...
        btnDialer.setOnClickListener {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                ...
                if (!rm.isRoleHeld(RoleManager.ROLE_DIALER)) {
                    ...
                    Toast.makeText(this, "Kaivor is already the default Phone app.", Toast.LENGTH_SHORT).show()
                }
            } else {
