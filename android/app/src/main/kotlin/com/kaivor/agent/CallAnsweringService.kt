...
/**
 * InCallService — Kaivor's AI call answering + outbound calling engine.
 *
 * INBOUND flow:
 ...
 *
 * Requires Kaivor set as default Phone app (Settings → Set as Default Phone App).
 */
class CallAnsweringService : InCallService() {

    companion object {
        const val CALL_CHANNEL      = "kaivor_calls"
        const val CALL_NOTIF_ID     = 42
        const val ACTION_TAKE_OVER  = "com.kaivor.agent.TAKE_OVER"
        const val ACTION_HANG_UP    = "com.kaivor.agent.HANG_UP"
    ...
    private fun createChannel() {
        val ch = NotificationChannel(CALL_CHANNEL, "Kaivor Calls",
