# BharatDroid Skill Specification
...
A skill is a Kotlin class that teaches BharatDroid how to control one specific app.
...
class MyAppSkill : Skill {
    ...
    override val manifest = SkillManifest(
        ...
        trusted = false,                        // only BharatDroid team sets true
        permissions = setOf(
            Permission.OPEN_APP,
